...
2. Oddanne zadanie musi sie bezwzglednie kompilowac na systemie Linux:
   ...
   - Aby się upewnić, że się kompiluje można skorzystać z [narzędzia online judge](https://domjudge.labagh.pl/) (VPN AGH konieczny).
      Aby wyslac zadanie nalezy wybrac konkurs (_Cpp_zad2_Matrix_), problem (_lab2 macierz_), oraz jezyk programowania (_cpp matrix UT_),
      prosze zalaczyc pliki @ref matrix.h, @ref matrix.cpp i @ref matrixElement.h
...
constexpr const char* const SURNAME   = "Rys";
constexpr const char* const MAIL    = "rys[at]student.agh.edu.pl";
