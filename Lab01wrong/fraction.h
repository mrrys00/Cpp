...
DONE 5. Do klasy dodaj zestaw metod dostępowych/modyfikujących obiekty klasy -tzw. gettery i settery,
...
DONE 6. Do klasy dodaj metodę print(), wypisującą atrybuty obiektu na konsolę w formie "licznik/mianownik\n"
   następnie ustaw jedynkę obok `IMPLEMENTED_hasPrintFunction`
DONE 7. Do klasy dodaj statyczny atrybut (removedFractions_)
...
DONE 8. Dodaj do klasy metody zapisz(std::ostream& os)/wczytaj(std::istream& is),
...
DONE 9. Proszę dodanie stałej odzwierciedlającej nazwę ułamka o nazwie `fractionName`,
...
//    explicit Fraction(std::string name);
